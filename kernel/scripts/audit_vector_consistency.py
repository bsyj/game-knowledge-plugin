...
def _build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="审计 GameKnowledge 向量一致性")
    parser.add_argument(
        "--data-dir",
        default=str(DEFAULT_DATA_DIR),
        help="GameKnowledge 数据目录（默认: data/game-knowledge）",
    )
...
def main() -> int:
    ...
    print("=== GameKnowledge Vector Consistency Audit ===")
