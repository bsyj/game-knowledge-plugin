"""GameKnowledge 内部模型任务选择工具。"""

from dataclasses import dataclass
from typing import Any, Dict, Iterable, Optional, Tuple

from gk_shims.logger_shim import get_logger
from gk_shims.data_models_shim import LLMServiceResult
...
def is_text_generation_task_name(task_name: str) -> bool:
    """判断任务名是否适合 GameKnowledge 的普通文本生成调用。"""
...
def get_text_generation_model_tasks(llm_api: Any, *, include_empty: bool = False) -> Dict[str, Any]:
    """从宿主 LLM API 中读取 GameKnowledge 可用的文本生成任务配置。"""
...
def pick_text_generation_task(
    ...
    preferred: Iterable[str] = GAME_KNOWLEDGE_TEXT_TASK_PRIORITY,
) -> Tuple[Optional[str], Optional[Any]]:
    """按 GameKnowledge 优先级选择文本生成任务。"""
...
async def generate_with_resolved_model(
    ...
    *,
    ...
    try:
        ...
        logger.error(f"[GameKnowledge.ModelRouting] {error_message}")
